                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a class="nav-link" id="loginButton" href="php/adoption.php">Adoption</a></li>
                                    <li class="nav-item"><a class="nav-link" id="loginButton" href="php/logout.php">Logout</a></li>
                                </ul>
